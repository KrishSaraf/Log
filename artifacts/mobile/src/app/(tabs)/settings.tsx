  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.sub}>
        Shared brand tokens with the web library. Auth sync with dashboard is not in this build.
      </Text>
      ...
      <View style={styles.tokenCard}>
        ...
        <Text style={styles.tokenLine}>accent #FF591A · bg #0A0A0A · card #141414</Text>
